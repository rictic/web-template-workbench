...
// defined here rather than via an argument to prodConfig() so we can
...
export function prodConfig({
  ...
  if (classPropertyPrefix === undefined) {
    throw new Error(
      `Package ${packageName} was being built using 'prodConfig' ` +
  ...
  // access internal details of index.js.
  //
...
export const defaultConfig = (options = {}) =>
  prodConfig({
    ...
    entryPoints: ["index", "modes", "template-from-literals"],
    outputDir: "./dist/",
    bundled: [],
